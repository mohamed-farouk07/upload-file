State Management: It keeps track of the file content (textContent), total word count (totalWords), loading state (isLoading), and a key to force re-rendering (key).
